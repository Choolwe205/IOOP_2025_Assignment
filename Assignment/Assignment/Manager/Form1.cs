...
namespace Assignment.Manager
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'iOOP_DatabaseDataSet.Resrvations' table. You can move, or remove it, as needed.
            this.resrvationsTableAdapter.Fill(this.iOOP_DatabaseDataSet.Resrvations);
