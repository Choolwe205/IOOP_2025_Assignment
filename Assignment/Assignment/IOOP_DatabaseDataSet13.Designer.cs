...
namespace Assignment {
    ...
    public partial class IOOP_DatabaseDataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/IOOP_DatabaseDataSet13.xsd";
        ...
        public partial class MenuDataTable : global::System.Data.TypedTableBase<MenuRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public MenuRow AddMenuRow(string FoodID, string Description, decimal Price) {
...
namespace Assignment.IOOP_DatabaseDataSet1TableAdapters {
    ...
    public partial class MenuTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Menu] WHERE (([FoodID] = @Original_FoodID) AND ([Description] " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Menu] ([FoodID], [Description], [Price]) VALUES (@FoodID, @Des" +
                "cription, @Price);\r\nSELECT FoodID, Description, Price FROM Menu WHERE (FoodID = " +
                "@FoodID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Menu] SET [FoodID] = @FoodID, [Description] = @Description, [Price] = @Price WHERE (([FoodID] = @Original_FoodID) AND ([Description] = @Original_Description) AND ([Price] = @Original_Price));
SELECT FoodID, Description, Price FROM Menu WHERE (FoodID = @FoodID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT FoodID, Description, Price FROM dbo.Menu";
        ...
        public virtual int Fill(IOOP_DatabaseDataSet1.MenuDataTable dataTable) {
        ...
        public virtual IOOP_DatabaseDataSet1.MenuDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            IOOP_DatabaseDataSet1.MenuDataTable dataTable = new IOOP_DatabaseDataSet1.MenuDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(IOOP_DatabaseDataSet1.MenuDataTable dataTable) {
        ...
        public virtual int Delete(string Original_FoodID, string Original_Description, decimal Original_Price) {
        ...
        public virtual int Insert(string FoodID, string Description, decimal Price) {
            if ((FoodID == null)) {
        ...
        public virtual int Update(string FoodID, string Description, decimal Price, string Original_FoodID, string Original_Description, decimal Original_Price) {
            if ((FoodID == null)) {
                throw new global::System.ArgumentNullException("FoodID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Description, decimal Price, string Original_FoodID, string Original_Description, decimal Original_Price) {
            return this.Update(Original_FoodID, Description, Price, Original_FoodID, Original_Description, Original_Price);
        }
    }
