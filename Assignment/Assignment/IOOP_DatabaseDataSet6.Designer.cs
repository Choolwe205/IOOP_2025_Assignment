...
namespace Assignment {
    ...
    public partial class IOOP_DatabaseDataSet6 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/IOOP_DatabaseDataSet6.xsd";
    ...
    public partial class MenuTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Menu] ([Description], [Price]) VALUES (@Description, @Price);\r" +
                "\nSELECT FoodID, Description, Price FROM Menu WHERE (FoodID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Menu] SET [Description] = @Description, [Price] = @Price WHERE (([F" +
                "oodID] = @Original_FoodID) AND ([Description] = @Original_Description) AND ([Pri" +
                "ce] = @Original_Price));\r\nSELECT FoodID, Description, Price FROM Menu WHERE (Foo" +
                "dID = @FoodID)";
        ...
        public virtual int Fill(IOOP_DatabaseDataSet6.MenuDataTable dataTable) {
        ...
        public virtual IOOP_DatabaseDataSet6.MenuDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            IOOP_DatabaseDataSet6.MenuDataTable dataTable = new IOOP_DatabaseDataSet6.MenuDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(IOOP_DatabaseDataSet6.MenuDataTable dataTable) {
        ...
        public virtual int Delete(int Original_FoodID, string Original_Description, decimal Original_Price) {
        ...
        public virtual int Update(string Description, decimal Price, int Original_FoodID, string Original_Description, decimal Original_Price, int FoodID) {
            if ((Description == null)) {
                throw new global::System.ArgumentNullException("Description");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Description, decimal Price, int Original_FoodID, string Original_Description, decimal Original_Price) {
            return this.Update(Description, Price, Original_FoodID, Original_Description, Original_Price, Original_FoodID);
        }
    }
